...
def extract_pdf_metadata(file_content: bytes) -> BookMetadata:
    ...
    try:
        ...
        if pdf_metadata:
            _extract_pdf_basic_fields(metadata, pdf_metadata)
            _extract_pdf_publication_year(metadata, pdf_metadata)
...
def extract_epub_metadata(file_content: bytes) -> BookMetadata:
    ...
    try:
        ...
        try:
            ...
            _extract_epub_basic_fields(metadata, book)
            _extract_epub_identifiers(metadata, book)
            _extract_epub_publication_date(metadata, book)
...
def _extract_epub_basic_fields(metadata: BookMetadata, book: epub.EpubBook) -> None:
...
def _extract_epub_identifiers(metadata: BookMetadata, book: epub.EpubBook) -> None:
...
def _extract_epub_publication_date(metadata: BookMetadata, book: epub.EpubBook) -> None:
...
def _extract_pdf_basic_fields(metadata: BookMetadata, pdf_metadata: dict) -> None:
...
def _extract_pdf_publication_year(metadata: BookMetadata, pdf_metadata: dict) -> None:
