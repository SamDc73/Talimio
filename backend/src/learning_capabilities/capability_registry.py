...
_CAPABILITIES: tuple[CapabilityDescriptor, ...] = (
    ...
    CapabilityDescriptor(
        ...
        requires_confirmation=False,
        public_api_eligible=True,
        description="Search attached book source excerpts for one owned course.",
    ),
    CapabilityDescriptor(
        name="search_books",
        kind="read",
        requires_confirmation=False,
        public_api_eligible=True,
        description="Search every book the user owns; results carry archived and ragStatus flags.",
    ),
    CapabilityDescriptor(
        name="list_books",
        kind="read",
        requires_confirmation=False,
        public_api_eligible=True,
        description="List every book the user owns; results carry archived and ragStatus flags.",
    ),
    CapabilityDescriptor(
        name="list_course_attachments",
        kind="read",
        requires_confirmation=False,
        public_api_eligible=True,
        description="List the books attached to one owned course.",
    ),
    CapabilityDescriptor(
    ...
    CapabilityDescriptor(
        name="attach_book_to_course",
        kind="write",
        requires_confirmation=True,
        public_api_eligible=True,
        description="Attach owned books to an owned course as grounding sources.",
    ),
    CapabilityDescriptor(
        name="detach_book_from_course",
        kind="write",
        requires_confirmation=True,
        public_api_eligible=True,
        description="Detach one book from a course; the book stays in the library.",
    ),
    CapabilityDescriptor(
