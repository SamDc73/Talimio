...
class CourseService(ICourseService):
    ...
    async def get_lesson_simplified(self, course_id: UUID, lesson_id: UUID, generate: bool = False) -> LessonResponse:
    ...
    async def generate_lesson(self, course_id: UUID, request: LessonCreate) -> LessonResponse:
    ...
    async def update_lesson(self, course_id: UUID, lesson_id: UUID, request: LessonUpdate) -> LessonResponse:
    ...
    async def get_lesson_status(self, course_id: UUID, module_id: UUID, lesson_id: UUID) -> LessonStatusResponse:
