...
class PracticeDrillService:
    ...
    async def generate_drills(
        ...
        *,
        ...
        while len(drills) < count and rounds < _MAX_GENERATION_ROUNDS:
            ...
            round_drills = await self._generate_round_drills(
                concept=concept,
    ...
    async def _generate_round_drills(
        self,
        *,
        concept: Concept,
        concept_id: uuid.UUID,
        ...
        for generated, predicted_value in ranked_candidates:
            ...
            if question_key in seen_questions:
                continue
            if round_number <= _STRICT_SIGNATURE_ROUNDS and signature in seen_signatures:
                continue
