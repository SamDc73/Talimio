		...
		async (showRefreshIndicator = false) => {
			try {
				...
				toast({
					...
					description:
						error.message ||
						"Unable to fetch course documents. Please try again.",
					variant: "destructive",
				});
			} finally {
				setIsLoading(false);
						...
						emptyMessage={
							<div className="text-center py-12">
								...
								<p className="text-gray-600 mb-6 max-w-md mx-auto">
									Upload documents to enable RAG-powered features like
									intelligent lesson generation and context-aware assistant
									responses.
								</p>
