...
export function useCourseService(courseId = null) {
  ...
  const generateLesson = useApi('/courses/{courseId}/lessons', { method: 'POST' });
  const regenerateLesson = useApi('/courses/{courseId}/lessons/{lessonId}/regenerate', { method: 'POST' });
  const updateLesson = useApi('/courses/{courseId}/lessons/{lessonId}', { method: 'PATCH' });
  const deleteLesson = useApi('/courses/{courseId}/lessons/{lessonId}', { method: 'DELETE' });
  ...
  return {
    ...
    async updateCourse(updateData) {
      if (!courseId) throw new Error('Course ID required');
      return await updateCourse.execute(updateData, { pathParams: { courseId } });
    },
    ...
    async generateLesson(lessonData) {
      if (!courseId) throw new Error('Course ID required');
      return await generateLesson.execute(lessonData, { pathParams: { courseId } });
    },
    ...
    async regenerateLesson(lessonId) {
      ...
      return await regenerateLesson.execute(null, { pathParams: { courseId, lessonId } });
    },
    ...
    async updateLesson(lessonId, updateData) {
      ...
      return await updateLesson.execute(updateData, { pathParams: { courseId, lessonId } });
    },
    ...
    async deleteLesson(lessonId) {
      ...
      return await deleteLesson.execute(null, { pathParams: { courseId, lessonId } });
    },
    ...
    async fetchLessonStatus(lessonId) {
      ...
      return await getLessonStatus.execute(null, { pathParams: { courseId, lessonId } });
    },
