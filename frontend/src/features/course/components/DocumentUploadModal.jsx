...
const DocumentUploadModal = ({ 
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const processingDocs = documents.map(doc => ({ ...doc, status: 'processing' }));
  ...
  const allCompleted = documents.length > 0 && documents.every(doc => 
          ...
          {!isUploading && !uploadResults && (
            <div className="mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
              <p className="text-sm text-blue-700 dark:text-blue-300">
                <strong>Document Integration:</strong> Uploaded documents will be processed and 
                integrated into the course's RAG system, making them searchable during lessons 
