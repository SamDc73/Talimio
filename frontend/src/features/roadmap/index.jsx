...
const RoadmapFlow = React.memo(
  React.forwardRef(({ roadmapId, onError }, ref) => {
    // Added React.forwardRef and ref parameter
    const { nodes, edges, isLoading, onNodesChange, onEdgesChange, handleConnect, initializeRoadmap } =
      useRoadmapState();
