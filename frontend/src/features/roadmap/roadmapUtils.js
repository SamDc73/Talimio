...
export const calculateNodePosition = (sourceNode, index) => {
  ...
  const position = {
    x: sourceNode.position.x + ROADMAP_DEFAULTS.NODE_SPACING.HORIZONTAL + randomOffset.x,
    y: sourceNode.position.y + index * ROADMAP_DEFAULTS.NODE_SPACING.VERTICAL + randomOffset.y,
  };
