    ...
    >
      ...
      <div className="mb-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm text-gray-900 font-medium">{course.progress || 0}%</span>
        </div>
      </div>
      ...
      <div className="flex justify-between items-center">
        ...
        <Link to={`/courses/${course.id}`} className="flex items-center gap-1 text-teal-600 hover:text-teal-700 text-sm font-medium">
          Resume
