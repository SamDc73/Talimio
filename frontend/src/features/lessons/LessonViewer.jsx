 ...
 * @returns {JSX.Element}
 */
export function LessonViewer({ lesson, isLoading, error, onBack, isDarkMode = false }) {
        ...
        >
          ...
          >
            <div className="flex items-center gap-2 mb-4">
              ...
              <div className={cn("flex items-center text-sm", isDarkMode ? "text-zinc-400" : "text-zinc-500")}>
            ...
            <h1 className={cn("text-2xl font-bold", isDarkMode ? "text-white" : "text-zinc-900")}>{lesson.title}</h1>
            <div className="flex items-center gap-2 mt-2">
              <span className={cn("text-sm", isDarkMode ? "text-zinc-400" : "text-zinc-500")}>
                Module {lesson.moduleId || 1}
              </span>
              <span className={cn("text-sm", isDarkMode ? "text-zinc-600" : "text-zinc-400")}>•</span>
              <span className={cn("text-sm", isDarkMode ? "text-zinc-400" : "text-zinc-500")}>5 min read</span>
            </div>
          </div>
          ...
          <div
            className={cn(
              ...
              isDarkMode ? "border-zinc-800 bg-zinc-800/50" : "border-zinc-200 bg-zinc-50"
            )}
          >
            <div>
              <button
