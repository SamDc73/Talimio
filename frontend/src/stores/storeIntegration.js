...
export function useUnifiedStore(courseId = null) {
  ...
  return {
    ...
    // Unified getters
    getActiveCourse: () => {
      return courseStore.getActiveCourse() || 
             (appStore.getActiveCourse() ? 
              { id: appStore.getActiveCourse() } : null);
    },
...
export function useModuleData(courseId, moduleId) {
  ...
  return {
    ...
    // Actions
    updateStatus: (status) => courseStore.updateModuleStatus(courseId, moduleId, status),
...
export function useLessonData(courseId, moduleId, lessonId) {
  ...
  return {
    ...
    // Actions
    updateStatus: (newStatus) => courseStore.updateLessonStatus(courseId, moduleId, lessonId, newStatus),
