...
import { MessageSquare, PanelLeft, BookOpen, Maximize } from "lucide-react";
      ...
      <div className="container mx-auto px-4">
        <div className="flex h-16 items-center">
          ...
          <div className="flex-1 min-w-0">
            <h1 className="text-base font-semibold text-slate-800 truncate">{bookTitle}</h1>
            <div className="flex items-center mt-1">
              {bookAuthor && (
                <span className="text-xs text-slate-600 mr-3">by {bookAuthor}</span>
              )}
          ...
          <div className="flex items-center gap-2">
            ...
            {showZoomControls && (
              <div className="flex items-center border border-slate-200 rounded-full h-8 px-1 bg-slate-50/50">
                <TooltipProvider>
                  <Tooltip>
