        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <DropdownMenuTrigger asChild>
              <button className="flex items-center rounded-full transition-all hover:bg-slate-100 focus:outline-none h-10 w-10 justify-center">
    ...
    <>
      ...
      <motion.div
        ...
        animate={{
          ...
          boxShadow: isPinned && isChatOpen ? "none" : "-4px 0 15px rgba(0, 0, 0, 0.1)",
        }}
        ...
        >
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              className={cn(isDarkMode ? "text-zinc-400 hover:text-white" : "text-slate-500 hover:text-slate-900")}
            >
              {isPinned ? <PinOff className="h-5 w-5" /> : <Pin className="h-5 w-5" />}
              <span className="sr-only">{isPinned ? "Unpin Chat" : "Pin Chat"}</span>
            </Button>
            <Button
              variant="ghost"
              size="icon"
