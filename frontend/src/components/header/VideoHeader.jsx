...
export function VideoHeader({ video, onToggleSidebar, isSidebarOpen }) {
  ...
  const progress = video ? Math.round(video.completion_percentage || 0) : 0
                ...
                <TooltipProvider>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      ...
                      >
                        <PanelRight className={`h-4 w-4 transition-transform duration-300 ${!isSidebarOpen ? "rotate-180" : ""}`} />
                      </Button>
                    </TooltipTrigger>
                    <TooltipContent>
