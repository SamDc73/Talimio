			...
			<div className="flex gap-2 mb-4">
				{Object.keys(SAMPLE_CODE).map((lang) => (
					<Button
						...
						variant={
							language === lang && !showHighlighted ? "default" : "outline"
						}
					>
						{lang}
					</Button>
			...
			{showHighlighted ? (
				<div>
					...
					<p className="mt-4 text-sm text-zinc-500">
						Note: Line and word highlighting requires rehype-pretty-code to be
						properly configured in MDX processing. This is just a visual
						example.
					</p>
				</div>
			) : (
