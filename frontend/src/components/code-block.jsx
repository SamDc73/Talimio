 ...
 * @returns {JSX.Element}
 */
export function CodeBlock({ code, language = "text", className = "", children }) {
  ...
  return (
    <div className={`relative group rounded-md overflow-hidden mb-4 ${className}`}>
      {/* Language badge */}
      ...
      {children ? (
        ...
        <pre ref={preRef} className="bg-[#eff1f5] p-4 rounded-md overflow-x-auto text-sm font-mono">
