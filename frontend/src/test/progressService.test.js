...
describe('Progress Service', () => {
  ...
  describe('getNodeProgress', () => {
    it('should fetch node progress successfully', async () => {
      ...
      expect(fetch).toHaveBeenCalledWith('/api/v1/progress/user/user-1/node/node-1')
    })
    ...
    it('should throw error on failed request', async () => {
      ...
      await expect(getNodeProgress('user-1', 'node-1')).rejects.toThrow('Failed to fetch progress: Not Found')
    })
  })
  ...
  describe('getUserProgress', () => {
    ...
    it('should handle fetch timeout', async () => {
      ...
      await expect(getUserProgress('user-1')).rejects.toThrow('Request timeout after 7000ms')
    })
  })
  ...
  describe('createNodeProgress', () => {
    it('should create node progress successfully', async () => {
      ...
      const mockResponse = { id: 'progress-1', nodeId: 'node-1', ...progressData }
