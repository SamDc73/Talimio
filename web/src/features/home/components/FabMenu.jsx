...
export default function FabMenu({ isFabExpanded, onToggleExpanded, onGenerateCourse, onUploadBook, onAddYoutube }) {
	return (
		<div className="fixed bottom-8 right-8 z-50">
			<AnimatePresence>
				{isFabExpanded && (
					...
					>
						...
						>
							<Sparkles className="size-6  text-course" />
						</TooltipButton>
						<TooltipButton
							variant="secondary"
							...
							tooltipDelayDuration={200}
						>
							<BookOpen className="size-6  text-book" />
						</TooltipButton>
						<TooltipButton
							variant="secondary"
			...
			<TooltipButton
				className="rounded-full size-16  shadow-lg hover:shadow-xl transition-all duration-200 hover:-translate-y-0.5 bg-primary hover:bg-primary/90"
