				...
				<form onSubmit={handleSubmit} className="p-6">
					...
					<div className="mb-6 p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-md">
						<p className="text-sm text-blue-700 dark:text-blue-300">
							<strong>AI will create:</strong> A structured course with modules
							and lessons tailored to your learning goals. You'll be able to
							customize it before starting.
						</p>
					</div>
